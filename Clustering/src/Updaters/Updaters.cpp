...
int PAM<Point>::update(vector<vector<Point>>* dataset, vector<int>** clusters, vector<vector<Point>*> centroids, DistanceDatabase<Point>* db) {                 //todo
...
template <class Point>
int MV_DTW<Point>::update(vector<vector<Point>>* dataset, vector<int>** clusters, vector<vector<Point>*> centroids, DistanceDatabase<Point>* db) {
    return 0;
}
